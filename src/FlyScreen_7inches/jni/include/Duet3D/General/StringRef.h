 ...
 *      Author: David
 *
 *  This file is a modified version of the StringRef.h source file from RRFLibraries
 *  The original can be found at https://github.com/Duet3D/RRFLibraries/blob/master/src/General/StringRef.h
 */
