 ...
 *      Author: David
 *
 *  This file is a modified version of the StringRef.cpp source file from RRFLibraries
 *  The original can be found at https://github.com/Duet3D/RRFLibraries/blob/master/src/General/StringRef.cpp
 */
